...
internals.parse = function (raw, preferences) {
    ...
    return internals.mediaPreferences(map, selections, preferences);
};
...
internals.sort = function (a, b) {
    ...
    if (a.type !== b.type) {
        return internals.sortToken(a, b, 'type');
    }

    // Sort by subtype

    if (a.subtype !== b.subtype) {
        return internals.sortToken(a, b, 'subtype');
    }
...
internals.sortToken = function (a, b, key) {
...
internals.mediaPreferences = function (map, selections, preferences) {
