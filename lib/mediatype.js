...
internals.compareByWeightAndSpecificity = function(a, b) {
    ...
    var aSlashParts = a.mediaType.split('/');
    var bSlashParts = b.mediaType.split('/');
    ...
    // console.log(aSlashParts, bSlashParts);
    ...
    var aHasExtension = ~aSlashParts[1].indexOf(';');
    var bHasExtension = ~bSlashParts[1].indexOf(';');
    if (aHasExtension) {
        return -1;
    }
